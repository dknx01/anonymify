...
use App\Anonymify\Db\Task\EmptyJsonTask;
...
class EmptyJsonTaskTest extends TestCase
{
    use ProphecyTrait;
    ...
    {
        $this->assertSame(80, EmptyJsonTask::getPriority());
    }
